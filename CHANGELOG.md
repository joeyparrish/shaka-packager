...
## [2.7.0](https://github.com/joeyparrish/shaka-packager/compare/v2.6.0...v2.7.0) (2023-10-20)


### Features

* Add CMake module for building protobufs ([#1112](https://github.com/joeyparrish/shaka-packager/issues/1112)) ([c3a4951](https://github.com/joeyparrish/shaka-packager/commit/c3a4951597f00b51e4feaa7b04c816c8c6220074))
* add install target for cmake ([#1269](https://github.com/joeyparrish/shaka-packager/issues/1269)) ([b224fb6](https://github.com/joeyparrish/shaka-packager/commit/b224fb6e57c1c8bff95c2247951e325068b1019b))
* add verbose logging flags for CMake branch ([#1266](https://github.com/joeyparrish/shaka-packager/issues/1266)) ([72117f8](https://github.com/joeyparrish/shaka-packager/commit/72117f85adfca3269600d5fd54af4b9801f6b81b))
* Add xHE-AAC support ([#1092](https://github.com/joeyparrish/shaka-packager/issues/1092)) ([84ba4af](https://github.com/joeyparrish/shaka-packager/commit/84ba4afc519db0cda80a059d92eeed603cc7f831))
...
* Build c-ares locally ([#1285](https://github.com/joeyparrish/shaka-packager/issues/1285)) ([fac8acf](https://github.com/joeyparrish/shaka-packager/commit/fac8acf5dd240a9def79472ad27b76570955fea0))
* CMake port media/origin ([#1145](https://github.com/joeyparrish/shaka-packager/issues/1145)) ([5d52d5e](https://github.com/joeyparrish/shaka-packager/commit/5d52d5e73cb4cc2c1c3e827b6dfc7c4b1dab5115))
* CMake port media/replicator ([#1144](https://github.com/joeyparrish/shaka-packager/issues/1144)) ([14a708d](https://github.com/joeyparrish/shaka-packager/commit/14a708d009a32aa98a609c4c2e6f98024ec3b8ff))
* CMake port media/trick_play ([#1146](https://github.com/joeyparrish/shaka-packager/issues/1146)) ([901013c](https://github.com/joeyparrish/shaka-packager/commit/901013c34e9a07f7bee3608c220f6e9c0d04095e))
* Cmake port mpd/media_info_proto ([#1152](https://github.com/joeyparrish/shaka-packager/issues/1152)) ([5f43570](https://github.com/joeyparrish/shaka-packager/commit/5f435708e77ffa8cbfb00d42a115944e38d8edf0))
* Cmake port of Media crypto ([#1221](https://github.com/joeyparrish/shaka-packager/issues/1221)) ([86bf6cf](https://github.com/joeyparrish/shaka-packager/commit/86bf6cf3cdcd5b1c92384d01761804e912d8d7a7))
* convert mpd module to cmake ([#1234](https://github.com/joeyparrish/shaka-packager/issues/1234)) ([96acd1e](https://github.com/joeyparrish/shaka-packager/commit/96acd1ecfdbf704800255424bb53eca6412aa973))
* copy packager_test.py in CMake ([#1284](https://github.com/joeyparrish/shaka-packager/issues/1284)) ([e516608](https://github.com/joeyparrish/shaka-packager/commit/e516608c5eab250498f77852643e464872df6c09))
...
* First phase of CMake build system implementation ([#1072](https://github.com/joeyparrish/shaka-packager/issues/1072)) ([e6b57f7](https://github.com/joeyparrish/shaka-packager/commit/e6b57f72a82f1172dc14589c0895072703200e4e))
...
* Move all third-party deps into git submodules ([#1083](https://github.com/joeyparrish/shaka-packager/issues/1083)) ([1ff26b4](https://github.com/joeyparrish/shaka-packager/commit/1ff26b4783f36bee139126028f762d6310cf9712))
* Port AES and RSA crypto to mbedtls ([#1119](https://github.com/joeyparrish/shaka-packager/issues/1119)) ([7b33f20](https://github.com/joeyparrish/shaka-packager/commit/7b33f2065f5769e9132239c41c7701b1295cff3e))
* Port app/job_manager to cmake and absl ([#1249](https://github.com/joeyparrish/shaka-packager/issues/1249)) ([ba51270](https://github.com/joeyparrish/shaka-packager/commit/ba51270b0e8a0d868bedccddd82de2c545373450))
* port demuxer and app to cmake ([#1260](https://github.com/joeyparrish/shaka-packager/issues/1260)) ([6b68c13](https://github.com/joeyparrish/shaka-packager/commit/6b68c138ccc3240dacb0251dddac9c680a8d5cab))
* port HLS module to CMake ([#1238](https://github.com/joeyparrish/shaka-packager/issues/1238)) ([ab8485c](https://github.com/joeyparrish/shaka-packager/commit/ab8485c5b78b584821926751fafffaeb1230540d))
* port media/base ([#1127](https://github.com/joeyparrish/shaka-packager/issues/1127)) ([b1095f6](https://github.com/joeyparrish/shaka-packager/commit/b1095f6bc36f38892c848689135b3d1dab1e7e1b))
* port media/chunking to CMake ([#1223](https://github.com/joeyparrish/shaka-packager/issues/1223)) ([ee0922e](https://github.com/joeyparrish/shaka-packager/commit/ee0922edf01865a39abc6f33e7f5b47f135e6feb))
* port media/codecs to CMake ([#1143](https://github.com/joeyparrish/shaka-packager/issues/1143)) ([e9bf0c6](https://github.com/joeyparrish/shaka-packager/commit/e9bf0c6de47a2627f2a105cd2fc4dc2c4d8a4a61))
* port media/event to CMake ([#1222](https://github.com/joeyparrish/shaka-packager/issues/1222)) ([8d3b2c6](https://github.com/joeyparrish/shaka-packager/commit/8d3b2c66b6e3f50a304a46751c58ff05d4d3bec3))
* port media/formats/* to cmake ([#1258](https://github.com/joeyparrish/shaka-packager/issues/1258)) ([3afe761](https://github.com/joeyparrish/shaka-packager/commit/3afe761637094e9fe7f3169699ac4c7af4bbd76b)), closes [#1047](https://github.com/joeyparrish/shaka-packager/issues/1047)
* port media/formats/webm to CMake ([#1147](https://github.com/joeyparrish/shaka-packager/issues/1147)) ([56d3304](https://github.com/joeyparrish/shaka-packager/commit/56d33040452b64fd31a4d8c2497a122f5f97ac07))
* port media/public/ ([#1117](https://github.com/joeyparrish/shaka-packager/issues/1117)) ([7ed49d4](https://github.com/joeyparrish/shaka-packager/commit/7ed49d4403447f7b4b353725cc36774c1594b398))
* port media/test ([#1116](https://github.com/joeyparrish/shaka-packager/issues/1116)) ([a9a4f0d](https://github.com/joeyparrish/shaka-packager/commit/a9a4f0d52cc06d99ac1744662d0060b650a1d808))
* Remove third-party source in-repo ([#1082](https://github.com/joeyparrish/shaka-packager/issues/1082)) ([8682081](https://github.com/joeyparrish/shaka-packager/commit/868208198ad38626b07452bc94ed2c024a77c5de))
* Replace arraysize with std::size ([#1129](https://github.com/joeyparrish/shaka-packager/issues/1129)) ([afd5fec](https://github.com/joeyparrish/shaka-packager/commit/afd5fec7cd194b71af0cd3192567a15e7465478c))
* Replace glog with absl::log ([#1274](https://github.com/joeyparrish/shaka-packager/issues/1274)) ([7653e1e](https://github.com/joeyparrish/shaka-packager/commit/7653e1e02f217a2c2049ba7045616bae0cf53a96))
* Respect the file mode for HttpFiles ([#1081](https://github.com/joeyparrish/shaka-packager/issues/1081)) ([31e116f](https://github.com/joeyparrish/shaka-packager/commit/31e116faec2181c2c9234e82ebab1fce6c3d4046))
...
* apply cmake fixes after merge of [#1210](https://github.com/joeyparrish/shaka-packager/issues/1210) ([#1264](https://github.com/joeyparrish/shaka-packager/issues/1264)) ([8b87804](https://github.com/joeyparrish/shaka-packager/commit/8b87804c57c158ab5f66e8de522fb0cca852a444))
...
* docs build ([#1257](https://github.com/joeyparrish/shaka-packager/issues/1257)) ([c465311](https://github.com/joeyparrish/shaka-packager/commit/c4653115250ce2b3adfeda2207076ad0f30127e1))
...
* Fix build errors since infra upgrades ([#1199](https://github.com/joeyparrish/shaka-packager/issues/1199)) ([84b0292](https://github.com/joeyparrish/shaka-packager/commit/84b02926e269ecea91f7f78252ae5d4e1a174ac4))
* Fix clang build ([#1288](https://github.com/joeyparrish/shaka-packager/issues/1288)) ([bcc2754](https://github.com/joeyparrish/shaka-packager/commit/bcc275454d20cab40d00d887ff9b0428a4ebf088)), closes [#561](https://github.com/joeyparrish/shaka-packager/issues/561)
* Fix compilation on Arch Linux ([#1233](https://github.com/joeyparrish/shaka-packager/issues/1233)) ([8bf2d45](https://github.com/joeyparrish/shaka-packager/commit/8bf2d4542419ef55eab7c582c5d8db665b931193))
* Fix dependency on system zlib ([#1291](https://github.com/joeyparrish/shaka-packager/issues/1291)) ([168e74c](https://github.com/joeyparrish/shaka-packager/commit/168e74c4c9c1e80e6fa354fb42095f2430e3a19c))
...
* Fix flush/close semantics for HTTP files, improve testing ([#1232](https://github.com/joeyparrish/shaka-packager/issues/1232)) ([af98d48](https://github.com/joeyparrish/shaka-packager/commit/af98d48726ccbc94be4ca92115e00d8e286206e7))
...
* Fix internal libraries built as dynamic by default ([#1283](https://github.com/joeyparrish/shaka-packager/issues/1283)) ([985abb2](https://github.com/joeyparrish/shaka-packager/commit/985abb23d63a90cd8d19cd922d6aafca3b9cf4cf))
...
* Fix libpng include directories ([#1245](https://github.com/joeyparrish/shaka-packager/issues/1245)) ([137e692](https://github.com/joeyparrish/shaka-packager/commit/137e69240618fc81f24ae9e3c47b89e8b571b097))
* Fix Linux build failures ([#1157](https://github.com/joeyparrish/shaka-packager/issues/1157)) ([41a5096](https://github.com/joeyparrish/shaka-packager/commit/41a50962ac573231d32ad62533ec26bb5666afa8))
* Fix local files with UTF8 names ([#1246](https://github.com/joeyparrish/shaka-packager/issues/1246)) ([5a2571b](https://github.com/joeyparrish/shaka-packager/commit/5a2571b9bcd1d1afb89b3c7d93bb9b11925130c5)), closes [#652](https://github.com/joeyparrish/shaka-packager/issues/652)
* Fix protoc linking on macOS w/ update to fork ([#1132](https://github.com/joeyparrish/shaka-packager/issues/1132)) ([44afbfc](https://github.com/joeyparrish/shaka-packager/commit/44afbfc8666688e80012941ceb68b721ac083e22))
* Fix status library headers and move test ([#1118](https://github.com/joeyparrish/shaka-packager/issues/1118)) ([6499387](https://github.com/joeyparrish/shaka-packager/commit/64993873c4de4525ff29983c513337bdb46d2001))
* Fix UdpFile build on FreeBSD ([#1287](https://github.com/joeyparrish/shaka-packager/issues/1287)) ([1e9b251](https://github.com/joeyparrish/shaka-packager/commit/1e9b251be885515000a85eb470fe27fef6d6f35e)), closes [#561](https://github.com/joeyparrish/shaka-packager/issues/561)
...
* Use stable GitHub mirror for libxml2 source ([#1286](https://github.com/joeyparrish/shaka-packager/issues/1286)) ([9294dc7](https://github.com/joeyparrish/shaka-packager/commit/9294dc7c6864ddb6f7733b24a326a75a28535206))
