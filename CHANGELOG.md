...
## [4.0.0](https://github.com/joeyparrish/shaka-packager/compare/v3.9.3...v4.0.0) (2026-08-21)
...
* --local_targetduration ([#1519](https://github.com/joeyparrish/shaka-packager/issues/1519)) ([4fad8d0](https://github.com/joeyparrish/shaka-packager/commit/4fad8d01c0bdac3b927195ccd2aeaaf882c6a61a)), closes [#1510](https://github.com/joeyparrish/shaka-packager/issues/1510)
* Add CENC v1 support ([#1539](https://github.com/joeyparrish/shaka-packager/issues/1539)) ([a792c56](https://github.com/joeyparrish/shaka-packager/commit/a792c567c73d30bab52878375d129ac3344c09dc))
* add CPIX support for encryption and decryption keys ([#1590](https://github.com/joeyparrish/shaka-packager/issues/1590)) ([22c64d3](https://github.com/joeyparrish/shaka-packager/commit/22c64d3c941de3738a944ed21e477eb8d7a047e4))
* add HLS AES-128 clear-key encryption for TS + MP4 ([#1572](https://github.com/joeyparrish/shaka-packager/issues/1572)) ([9d96f9c](https://github.com/joeyparrish/shaka-packager/commit/9d96f9c29a3ce246bac37af4b5e1138232457762))
...
* Add signaling for CEA-608/708 captions ([#1532](https://github.com/joeyparrish/shaka-packager/issues/1532)) ([3aafed8](https://github.com/joeyparrish/shaka-packager/commit/3aafed82b6ce8d47b028acafc547dcdf5030a749)), closes [#986](https://github.com/joeyparrish/shaka-packager/issues/986)
...
* add subsample encryption support for Dolby AC-4 ([#1522](https://github.com/joeyparrish/shaka-packager/issues/1522)) ([3e854f4](https://github.com/joeyparrish/shaka-packager/commit/3e854f4c907fdd4d0a5491304d9ad616f1a935bd))
...
* Add support for EXT-X-PROGRAM-DATE-TIME tag ([#1521](https://github.com/joeyparrish/shaka-packager/issues/1521)) ([73b4048](https://github.com/joeyparrish/shaka-packager/commit/73b40484924108953f9e3318574d92af135f22ea)), closes [#365](https://github.com/joeyparrish/shaka-packager/issues/365)
...
* **cmake:** allow external declaration of version string ([#1552](https://github.com/joeyparrish/shaka-packager/issues/1552)) ([8431c33](https://github.com/joeyparrish/shaka-packager/commit/8431c336c29883479ee773f03871492038494ae5))
* **cmake:** allow using system dependencies ([#1562](https://github.com/joeyparrish/shaka-packager/issues/1562)) ([2c6790a](https://github.com/joeyparrish/shaka-packager/commit/2c6790a8cb17677b9c9a64d1ab0f5d5c21a305a9))
* DASH - Add signaling for CEA-608/708 captions ([#1549](https://github.com/joeyparrish/shaka-packager/issues/1549)) ([51e25b5](https://github.com/joeyparrish/shaka-packager/commit/51e25b56ee7ed3cf1302293045b249e4d25d76fe))
...
* default text zero bias ([#1330](https://github.com/joeyparrish/shaka-packager/issues/1330)) ([2ba67bc](https://github.com/joeyparrish/shaka-packager/commit/2ba67bc24cf6116349ad16d3bfa1a121c95a3173))
...
* omit PSSH in MP4 for DASH-IF IOP compliant output ([#1609](https://github.com/joeyparrish/shaka-packager/issues/1609)) ([5c3deac](https://github.com/joeyparrish/shaka-packager/commit/5c3deac8fce26ad7264d6baef5b91daa35611104)), closes [#640](https://github.com/joeyparrish/shaka-packager/issues/640)
...
* Switch VOD to live stream when event/live streams end ([#1541](https://github.com/joeyparrish/shaka-packager/issues/1541)) ([ef8ed34](https://github.com/joeyparrish/shaka-packager/commit/ef8ed345dee03fdad37e5b67958b2f5ccb984314)), closes [#321](https://github.com/joeyparrish/shaka-packager/issues/321)
...
* AdaptationSet ID inconsistency across periods ([#1547](https://github.com/joeyparrish/shaka-packager/issues/1547)) ([6c7fb18](https://github.com/joeyparrish/shaka-packager/commit/6c7fb18d3bd87a680034675fae60392ff56a8008))
...
* apply skip_encryption/drm_label per-output for shared streams ([#1601](https://github.com/joeyparrish/shaka-packager/issues/1601)) ([0c38fe1](https://github.com/joeyparrish/shaka-packager/commit/0c38fe16aa42132a5585703952473d84855a344f))
...
* **ci:** Update release for trusted publishing to NPM ([#1544](https://github.com/joeyparrish/shaka-packager/issues/1544)) ([4b3d1f9](https://github.com/joeyparrish/shaka-packager/commit/4b3d1f98f9b62d3966385456b027c57e8ed0697d))
* correct AES-128 whole-segment encryption for MP4/CMAF HLS ([#1594](https://github.com/joeyparrish/shaka-packager/issues/1594)) ([a01ce20](https://github.com/joeyparrish/shaka-packager/commit/a01ce20f97e28bcd021b8b7e4de1522ec1b9c999)), closes [#1588](https://github.com/joeyparrish/shaka-packager/issues/1588) [#1587](https://github.com/joeyparrish/shaka-packager/issues/1587)
* correct WebM color range value mapping for vpcC and colr boxes ([#1554](https://github.com/joeyparrish/shaka-packager/issues/1554)) ([34352c1](https://github.com/joeyparrish/shaka-packager/commit/34352c16d3c068038ba7733af84e63abafcde864))
* DASH ondemand mpd - use SegmentBase for single-file text tracks in multi period manifest ([#1579](https://github.com/joeyparrish/shaka-packager/issues/1579)) ([b35c3cc](https://github.com/joeyparrish/shaka-packager/commit/b35c3ccab639c55dcac7c758c23e264fb42343a9))
...
* **deps:** update abseil-cpp to 20260107.1, protobuf to 33.5 ([#1553](https://github.com/joeyparrish/shaka-packager/issues/1553)) ([27a1d71](https://github.com/joeyparrish/shaka-packager/commit/27a1d71e3d31bea4893bd365b3aabe1031326bad))
* **deps:** update to curl v8.19.0, mbedtls v3.6.5, libxml2 v2.15.2 ([#1563](https://github.com/joeyparrish/shaka-packager/issues/1563)) ([1e5fa9a](https://github.com/joeyparrish/shaka-packager/commit/1e5fa9ab283789fa5d741cf74b2039d97c4f883d))
...
* DVB-Teletext: heartbeat mechanism and segment alignment with video/audio ([#1535](https://github.com/joeyparrish/shaka-packager/issues/1535)) ([19dbd20](https://github.com/joeyparrish/shaka-packager/commit/19dbd203b01bfecf646384e89f8a6da1ea343d35)), closes [#1428](https://github.com/joeyparrish/shaka-packager/issues/1428) [#1401](https://github.com/joeyparrish/shaka-packager/issues/1401) [#1355](https://github.com/joeyparrish/shaka-packager/issues/1355) [#1430](https://github.com/joeyparrish/shaka-packager/issues/1430)
...
* Explicitly signal the lack of CEA captions in HLS ([d48bf0f](https://github.com/joeyparrish/shaka-packager/commit/d48bf0f48ee3e37f797d2186885af9f9747482aa)), closes [#922](https://github.com/joeyparrish/shaka-packager/issues/922)
...
* Fix color range info loss in WebM input to init mp4 packaging  ([#1517](https://github.com/joeyparrish/shaka-packager/issues/1517)) ([8dd9a6d](https://github.com/joeyparrish/shaka-packager/commit/8dd9a6d5882cb7c6d021442c09cc42463485b05f)), closes [#1515](https://github.com/joeyparrish/shaka-packager/issues/1515)
...
* Fix parsing of av1 metadata OBUs ([#1611](https://github.com/joeyparrish/shaka-packager/issues/1611)) ([207fb00](https://github.com/joeyparrish/shaka-packager/commit/207fb007edd833611851e20816ff8dd6d4055e0a))
...
* Fix supplemental properties pointing to wrong AdaptationSet IDs ([#1520](https://github.com/joeyparrish/shaka-packager/issues/1520)) ([5776b0b](https://github.com/joeyparrish/shaka-packager/commit/5776b0b60d52c41732279e17fa2388d72d5a606d)), closes [#1500](https://github.com/joeyparrish/shaka-packager/issues/1500)
...
* handle EEXIST error in directory creation ([#1526](https://github.com/joeyparrish/shaka-packager/issues/1526)) ([6144a49](https://github.com/joeyparrish/shaka-packager/commit/6144a497016818b2042152eb96f248a8e0577f2b))
* harden MP4/codec parsers against out-of-bounds boundary conditions ([#1603](https://github.com/joeyparrish/shaka-packager/issues/1603)) ([4e891d2](https://github.com/joeyparrish/shaka-packager/commit/4e891d293f127163aab7164b2469254ee673efb4))
* HLS - remove CLOSED-CAPTIONS from EXT-X-I-FRAME-STREAM-INF ([#1551](https://github.com/joeyparrish/shaka-packager/issues/1551)) ([16a2462](https://github.com/joeyparrish/shaka-packager/commit/16a2462dd8a00fbcaec06e1aaf86b732ba0111eb))
* hls default yes ([#1578](https://github.com/joeyparrish/shaka-packager/issues/1578)) ([49f9d8e](https://github.com/joeyparrish/shaka-packager/commit/49f9d8e27eb98ffd579e8ba0f855dcf0f0a48c8c))
...
* **hls:** emit EXT-X-MEDIA tags in command-line order, not by GROUP-ID ([#1374](https://github.com/joeyparrish/shaka-packager/issues/1374)) ([b1580dd](https://github.com/joeyparrish/shaka-packager/commit/b1580dd18b804a5d082d50558da38bca4acdef6a))
...
* Ignore already-deleted files when removing old segments ([#1566](https://github.com/joeyparrish/shaka-packager/issues/1566)) ([8cc64e2](https://github.com/joeyparrish/shaka-packager/commit/8cc64e22e2f2fd3c89b39e05a3277b4e4c636dcf))
...
* **isobmff:** validate stts entry count before allocation ([#1597](https://github.com/joeyparrish/shaka-packager/issues/1597)) ([7c011ac](https://github.com/joeyparrish/shaka-packager/commit/7c011aca277d0957366300ad79379cb519d348dc))
...
* Move cipher block align to start of block ([#1540](https://github.com/joeyparrish/shaka-packager/issues/1540)) ([e981da5](https://github.com/joeyparrish/shaka-packager/commit/e981da5ad892f5008c71a85df5974714f76b3cc1))
* **mp2t:** group multiple HEVC slices per picture into one access unit ([#1608](https://github.com/joeyparrish/shaka-packager/issues/1608)) ([75d4297](https://github.com/joeyparrish/shaka-packager/commit/75d4297c300fc9c38583202febde14e11917bdeb)), closes [#1363](https://github.com/joeyparrish/shaka-packager/issues/1363)
...
* **mp4:** size next_fragment_start_dts_ by max track_id to fix OOB crash ([#1602](https://github.com/joeyparrish/shaka-packager/issues/1602)) ([b540ed8](https://github.com/joeyparrish/shaka-packager/commit/b540ed842fbb309537065e2c20535d7ac3f68fbf)), closes [#1368](https://github.com/joeyparrish/shaka-packager/issues/1368)
* **mp4:** skip empty CodecConfiguration box instead of corrupting output ([#1606](https://github.com/joeyparrish/shaka-packager/issues/1606)) ([2267ba0](https://github.com/joeyparrish/shaka-packager/commit/2267ba0998286489ea838f09751d2c4a9021c6ac)), closes [#1142](https://github.com/joeyparrish/shaka-packager/issues/1142)
* **mp4:** support negative pts with a pts/dts offset via edit list ([#1610](https://github.com/joeyparrish/shaka-packager/issues/1610)) ([f786419](https://github.com/joeyparrish/shaka-packager/commit/f7864191bf0f83c66049cac1beb56b0f36a9f270)), closes [#1265](https://github.com/joeyparrish/shaka-packager/issues/1265)
* normalize video_full_range_flag to 0 or 1 in av1 codec string ([#1586](https://github.com/joeyparrish/shaka-packager/issues/1586)) ([f2fb7ef](https://github.com/joeyparrish/shaka-packager/commit/f2fb7ef2a7af6c0eadc7e136939469586a2bdb4d))
...
* pssh-box tool missing python_edition_defaults ([#1581](https://github.com/joeyparrish/shaka-packager/issues/1581)) ([a528a6f](https://github.com/joeyparrish/shaka-packager/commit/a528a6fc589d762eef0837622770b2f6d075cade))
...
* resolve relative paths for atomic write target ([#1564](https://github.com/joeyparrish/shaka-packager/issues/1564)) ([90a392e](https://github.com/joeyparrish/shaka-packager/commit/90a392ed8a30bc30697a3bec3115f4d2dff3a580))
...
* revert [#1540](https://github.com/joeyparrish/shaka-packager/issues/1540) cipher-block alignment to restore one-subsample-per-NALU layout ([#1598](https://github.com/joeyparrish/shaka-packager/issues/1598)) ([14529b6](https://github.com/joeyparrish/shaka-packager/commit/14529b669dec6f2d91338663d7b5bc41e66c4ce2))
...
* Upgrade deps that are meant for older versions of CMake ([#1508](https://github.com/joeyparrish/shaka-packager/issues/1508)) ([e46b759](https://github.com/joeyparrish/shaka-packager/commit/e46b7591e1e4ff3444e306061746aa42589c84d7))
* Upgrade libpng to fix build on new macs ([#1507](https://github.com/joeyparrish/shaka-packager/issues/1507)) ([7cd7e48](https://github.com/joeyparrish/shaka-packager/commit/7cd7e48e9cfd008542c2f7c7c292bde15837a15e))
...
* **webm:** preserve VP8/VP9 alpha (transparency) channel ([#1607](https://github.com/joeyparrish/shaka-packager/issues/1607)) ([5b99ed0](https://github.com/joeyparrish/shaka-packager/commit/5b99ed07470b511fbb17c726d509b1ec2dcd3ccb)), closes [#1168](https://github.com/joeyparrish/shaka-packager/issues/1168)
